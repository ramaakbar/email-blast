...
const en_compose_stepsmtp1 = /** @type {(inputs: Compose_Stepsmtp1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`SMTP`)
};

const id_compose_stepsmtp1 = /** @type {(inputs: Compose_Stepsmtp1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`SMTP`)
};
...
const compose_stepsmtp1 = /** @type {((inputs?: Compose_Stepsmtp1Inputs, options?: { locale?: "en" | "id" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Compose_Stepsmtp1Inputs, { locale?: "en" | "id" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "id") return id_compose_stepsmtp1(inputs)
	return en_compose_stepsmtp1(inputs)
});
