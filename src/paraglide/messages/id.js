...
export const nav_generate = /** @type {(inputs: Nav_GenerateInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Generate`)
};

export const nav_send = /** @type {(inputs: Nav_SendInputs) => LocalizedString} */ () => {
...
export const status_generating = /** @type {(inputs: Status_GeneratingInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Memproses`)
};

export const status_generated = /** @type {(inputs: Status_GeneratedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Selesai`)
};
...
export const smtp_defaultsendername2 = /** @type {(inputs: Smtp_Defaultsendername2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Nama pengirim bawaan`)
};

export const smtp_defaultsenderaddress2 = /** @type {(inputs: Smtp_Defaultsenderaddress2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Alamat pengirim bawaan`)
};

export const smtp_replyto1 = /** @type {(inputs: Smtp_Replyto1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Balas-ke (opsional)`)
};

export const smtp_identityhint1 = /** @type {(inputs: Smtp_Identityhint1Inputs) => LocalizedString} */ () => {
...
export const compose_stepgenerate1 = /** @type {(inputs: Compose_Stepgenerate1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Generate & Tinjau`)
};
...
export const compose_trydifferentfilter2 = /** @type {(inputs: Compose_Trydifferentfilter2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Coba pencarian atau filter batch yang lain.`)
};
...
export const compose_replyto1 = /** @type {(inputs: Compose_Replyto1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Balas-ke`)
};

export const compose_senderdomainmismatch2 = /** @type {(inputs: Compose_Senderdomainmismatch2Inputs) => LocalizedString} */ (i) => {
...
export const compose_senderdiffersfromprofile3 = /** @type {(inputs: Compose_Senderdiffersfromprofile3Inputs) => LocalizedString} */ (i) => {
...
export const compose_replytoplaceholder2 = /** @type {(inputs: Compose_Replytoplaceholder2Inputs) => LocalizedString} */ () => {
...
export const templates_slotlayouttitle2 = /** @type {(inputs: Templates_Slotlayouttitle2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Posisikan teks pada gambar`)
};

export const templates_slotlayouthint2 = /** @type {(inputs: Templates_Slotlayouthint2Inputs) => LocalizedString} */ () => {
...
export const templates_slotlayoutdone2 = /** @type {(inputs: Templates_Slotlayoutdone2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Selesai`)
};

export const templates_slotlayoutimagefailed3 = /** @type {(inputs: Templates_Slotlayoutimagefailed3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Gagal memuat gambar template.`)
};

export const templates_positiontextonimage3 = /** @type {(inputs: Templates_Positiontextonimage3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Posisikan teks pada gambar…`)
};

export const templates_slotx1 = /** @type {(inputs: Templates_Slotx1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`X`)
};

export const templates_sloty1 = /** @type {(inputs: Templates_Sloty1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Y`)
};

export const templates_slotfontsize2 = /** @type {(inputs: Templates_Slotfontsize2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ukuran huruf`)
};

export const templates_slotmaxwidth2 = /** @type {(inputs: Templates_Slotmaxwidth2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Lebar maksimum`)
};

export const templates_slotmaxwidthauto3 = /** @type {(inputs: Templates_Slotmaxwidthauto3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Otomatis (hingga tepi halaman)`)
};

export const templates_slotcolor1 = /** @type {(inputs: Templates_Slotcolor1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Warna`)
};

export const templates_slotalign1 = /** @type {(inputs: Templates_Slotalign1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Perataan`)
};

export const templates_slotalignleft2 = /** @type {(inputs: Templates_Slotalignleft2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Rata kiri`)
};

export const templates_slotaligncenter2 = /** @type {(inputs: Templates_Slotaligncenter2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Rata tengah`)
};

export const templates_slotalignright2 = /** @type {(inputs: Templates_Slotalignright2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Rata kanan`)
};

export const templates_slotfontface2 = /** @type {(inputs: Templates_Slotfontface2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Jenis huruf`)
};

export const templates_slotfontfacedefault3 = /** @type {(inputs: Templates_Slotfontfacedefault3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Bawaan (Helvetica Bold)`)
};

export const templates_addfont1 = /** @type {(inputs: Templates_Addfont1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tambah huruf…`)
};

export const templates_fontadded1 = /** @type {(inputs: Templates_Fontadded1Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Huruf "${i?.family}" ditambahkan.`)
};

export const templates_fontaddfailed2 = /** @type {(inputs: Templates_Fontaddfailed2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Gagal menambahkan file huruf.`)
};

export const templates_fontlistfailed2 = /** @type {(inputs: Templates_Fontlistfailed2Inputs) => LocalizedString} */ () => {
...
export const importpage_allowduplicates2 = /** @type {(inputs: Importpage_Allowduplicates2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Izinkan email duplikat`)
};

export const importpage_allowduplicateshint3 = /** @type {(inputs: Importpage_Allowduplicateshint3Inputs) => LocalizedString} */ () => {
...
export const importpage_gotogenerate3 = /** @type {(inputs: Importpage_Gotogenerate3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Buka Generate`)
};

export const importpage_roletemplate2 = /** @type {(inputs: Importpage_Roletemplate2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Template`)
};
...
export const recipients_edit = /** @type {(inputs: Recipients_EditInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Edit`)
};

export const recipients_edittitle1 = /** @type {(inputs: Recipients_Edittitle1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Edit penerima`)
};

export const recipients_updated = /** @type {(inputs: Recipients_UpdatedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Penerima diperbarui.`)
};

export const recipients_couldnotupdate2 = /** @type {(inputs: Recipients_Couldnotupdate2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Gagal memperbarui penerima.`)
};

export const recipients_namerequired1 = /** @type {(inputs: Recipients_Namerequired1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Nama wajib diisi.`)
};

export const recipients_emailmustcontainat3 = /** @type {(inputs: Recipients_Emailmustcontainat3Inputs) => LocalizedString} */ () => {
...
export const jobdetail_fixemail2 = /** @type {(inputs: Jobdetail_Fixemail2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Perbaiki email`)
};

export const jobdetail_fixemailtitle3 = /** @type {(inputs: Jobdetail_Fixemailtitle3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Perbaiki alamat email`)
};

export const jobdetail_recipientdeletednoedit4 = /** @type {(inputs: Jobdetail_Recipientdeletednoedit4Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Penerima ini telah dihapus - baris ini hanya bisa dibaca.`)
};

export const jobdetail_emailfixedretrying3 = /** @type {(inputs: Jobdetail_Emailfixedretrying3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Alamat diperbaiki - mencoba kirim ulang.`)
};

export const jobdetail_couldnotfixemail4 = /** @type {(inputs: Jobdetail_Couldnotfixemail4Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Gagal memperbaiki email.`)
};

export const send_title = /** @type {(inputs: Send_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Kirim`)
};

export const send_description = /** @type {(inputs: Send_DescriptionInputs) => LocalizedString} */ () => {
...
export const send_recipientsource1 = /** @type {(inputs: Send_Recipientsource1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Sumber penerima`)
};

export const send_sourcefromjob2 = /** @type {(inputs: Send_Sourcefromjob2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Dari Generate Job`)
};

export const send_sourcefromjobhint3 = /** @type {(inputs: Send_Sourcefromjobhint3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Kirim email PDF hasil generate sebelumnya tanpa membuat ulang.`)
};

export const send_sourcefromlist2 = /** @type {(inputs: Send_Sourcefromlist2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Dari daftar impor`)
};

export const send_sourcefromlisthint3 = /** @type {(inputs: Send_Sourcefromlisthint3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Pesan biasa tanpa lampiran.`)
};

export const send_choosejob1 = /** @type {(inputs: Send_Choosejob1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Pilih Generate Job…`)
};

export const send_nogeneratejobsyet3 = /** @type {(inputs: Send_Nogeneratejobsyet3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Belum ada riwayat generate.`)
};

export const send_nogeneratejobshint3 = /** @type {(inputs: Send_Nogeneratejobshint3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Buat dokumen dulu - PDF-nya menjadi lampiran yang dikirim workspace ini.`)
};

export const send_joboption1 = /** @type {(inputs: Send_Joboption1Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.template} · ${i?.generated} berhasil · ${i?.failed} gagal · ${i?.stamp}`)
};

export const send_couldnotloadjobs3 = /** @type {(inputs: Send_Couldnotloadjobs3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tidak dapat memuat riwayat generate.`)
};

export const send_couldnotloadjob3 = /** @type {(inputs: Send_Couldnotloadjob3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tidak dapat memuat generate job.`)
};

export const send_jobrecipients1 = /** @type {(inputs: Send_Jobrecipients1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Penerima pekerjaan ini`)
};

export const send_jobrecipientshint2 = /** @type {(inputs: Send_Jobrecipientshint2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Penerima yang gagal generate ditandai - mereka tetap bisa menerima pesan, tanpa PDF.`)
};

export const send_filterall1 = /** @type {(inputs: Send_Filterall1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Semua`)
};

export const send_filterwithattachment2 = /** @type {(inputs: Send_Filterwithattachment2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Dengan lampiran`)
};

export const send_filterwithoutattachment2 = /** @type {(inputs: Send_Filterwithoutattachment2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tanpa lampiran`)
};

export const send_attachmentfilteraria2 = /** @type {(inputs: Send_Attachmentfilteraria2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Filter berdasarkan lampiran`)
};

export const send_generatestatus1 = /** @type {(inputs: Send_Generatestatus1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Status generate`)
};

export const send_attachment = /** @type {(inputs: Send_AttachmentInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Lampiran`)
};

export const send_rowhasattachment2 = /** @type {(inputs: Send_Rowhasattachment2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ada PDF`)
};

export const send_rownoattachment2 = /** @type {(inputs: Send_Rownoattachment2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tanpa PDF`)
};

export const send_failedgeneratetitle2 = /** @type {(inputs: Send_Failedgeneratetitle2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Generate gagal - pesan terkirim tanpa PDF`)
};

export const send_norecipientsinjob3 = /** @type {(inputs: Send_Norecipientsinjob3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Generate job ini tidak punya penerima.`)
};

export const send_preflighthint1 = /** @type {(inputs: Send_Preflighthint1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Pre-flight memeriksa koneksi SMTP sebelum email pertama terkirim.`)
};

export const send_attachmentssummary1 = /** @type {(inputs: Send_Attachmentssummary1Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.with} dengan PDF · ${i?.without} tanpa`)
};

export const send_sendthese1 = /** @type {(inputs: Send_Sendthese1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Kirim ini`)
};

export const send_prefillretryone2 = /** @type {(inputs: Send_Prefillretryone2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.count} penerima gagal diisi ulang dari Log: pesan dan SMTP yang sama.`)
};

export const send_prefillretryother2 = /** @type {(inputs: Send_Prefillretryother2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.count} penerima gagal diisi ulang dari Log: pesan dan SMTP yang sama.`)
};

export const send_prefillreenterpassword2 = /** @type {(inputs: Send_Prefillreenterpassword2Inputs) => LocalizedString} */ () => {
...
export const send_prefilldeletedone2 = /** @type {(inputs: Send_Prefilldeletedone2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.count} penerima yang sebelumnya gagal telah dihapus.`)
};

export const send_prefilldeletedother2 = /** @type {(inputs: Send_Prefilldeletedother2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.count} penerima yang sebelumnya gagal telah dihapus.`)
};
...
export const sendjob_generatejobmissing3 = /** @type {(inputs: Sendjob_Generatejobmissing3Inputs) => LocalizedString} */ () => {
...
export const sendjob_quitinprogress3 = /** @type {(inputs: Sendjob_Quitinprogress3Inputs) => LocalizedString} */ (i) => {
...
export const sendjob_quitandpause3 = /** @type {(inputs: Sendjob_Quitandpause3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Keluar & Jeda`)
};

export const sendjob_keepsending2 = /** @type {(inputs: Sendjob_Keepsending2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Lanjutkan Mengirim`)
};

export const sendjob_launchbanner2 = /** @type {(inputs: Sendjob_Launchbanner2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Pengiriman dijeda: ${i?.subject} - ${i?.sent} dari ${i?.total} terkirim.`)
};

export const sendjob_credentialunreadable2 = /** @type {(inputs: Sendjob_Credentialunreadable2Inputs) => LocalizedString} */ () => {
...
export const generatejob_unassignedtemplatevalues3 = /** @type {(inputs: Generatejob_Unassignedtemplatevalues3Inputs) => LocalizedString} */ (i) => {
...
export const generatejob_unassignedtemplatevalue3 = /** @type {(inputs: Generatejob_Unassignedtemplatevalue3Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Nilai kolom template "${i?.value}" belum ditetapkan ke template mana pun.`)
};

export const generatejob_routingcolumnrequired3 = /** @type {(inputs: Generatejob_Routingcolumnrequired3Inputs) => LocalizedString} */ () => {
...
export const fontsservice_invalidfontfile3 = /** @type {(inputs: Fontsservice_Invalidfontfile3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Itu bukan file huruf TTF/OTF yang dapat dibaca.`)
};

export const fontsservice_couldnotread3 = /** @type {(inputs: Fontsservice_Couldnotread3Inputs) => LocalizedString} */ (i) => {
...
export const validation_messagetemplatenamerequired3 = /** @type {(inputs: Validation_Messagetemplatenamerequired3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Nama template pesan wajib diisi.`)
};

export const validation_messagesubjectrequired2 = /** @type {(inputs: Validation_Messagesubjectrequired2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Subjek wajib diisi.`)
};

export const validation_messagebodyrequired2 = /** @type {(inputs: Validation_Messagebodyrequired2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Isi HTML wajib diisi.`)
};

export const validation_slotlayoutinvalid2 = /** @type {(inputs: Validation_Slotlayoutinvalid2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Slot "${i?.slot}" memiliki konfigurasi posisi teks yang tidak valid.`)
};

export const validation_patternslotmissingintemplate4 = /** @type {(inputs: Validation_Patternslotmissingintemplate4Inputs) => LocalizedString} */ (i) => {
...
export const dialogs_pdffilter1 = /** @type {(inputs: Dialogs_Pdffilter1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`PDF`)
};

export const dialogs_fontfilter1 = /** @type {(inputs: Dialogs_Fontfilter1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Font`)
};

export const messages_documentstab1 = /** @type {(inputs: Messages_Documentstab1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Dokumen`)
};

export const messages_messagestab1 = /** @type {(inputs: Messages_Messagestab1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Pesan`)
};

export const messages_addmessagetemplate2 = /** @type {(inputs: Messages_Addmessagetemplate2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tambah template pesan`)
};

export const messages_countone1 = /** @type {(inputs: Messages_Countone1Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.count} template pesan`)
};

export const messages_countother1 = /** @type {(inputs: Messages_Countother1Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.count} template pesan`)
};

export const messages_notemplatesyet2 = /** @type {(inputs: Messages_Notemplatesyet2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Belum ada template pesan`)
};

export const messages_notemplateshint2 = /** @type {(inputs: Messages_Notemplateshint2Inputs) => LocalizedString} */ () => {
...
export const messages_addtitle1 = /** @type {(inputs: Messages_Addtitle1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Template pesan baru`)
};

export const messages_edittitle1 = /** @type {(inputs: Messages_Edittitle1Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Edit ${i?.name}`)
};

export const messages_edit = /** @type {(inputs: Messages_EditInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Edit`)
};

export const messages_registered = /** @type {(inputs: Messages_RegisteredInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Template pesan "${i?.name}" disimpan.`)
};

export const messages_saved = /** @type {(inputs: Messages_SavedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Template pesan disimpan.`)
};

export const messages_deleted = /** @type {(inputs: Messages_DeletedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Template pesan dihapus.`)
};

export const messages_couldnotload2 = /** @type {(inputs: Messages_Couldnotload2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Gagal memuat template pesan.`)
};

export const messages_couldnotsave2 = /** @type {(inputs: Messages_Couldnotsave2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Gagal menyimpan template pesan.`)
};

export const messages_couldnotdelete2 = /** @type {(inputs: Messages_Couldnotdelete2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Gagal menghapus template pesan.`)
};

export const messages_updatedstamp1 = /** @type {(inputs: Messages_Updatedstamp1Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Diedit ${i?.stamp}`)
};

export const messages_bodyhint1 = /** @type {(inputs: Messages_Bodyhint1Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Kolom penerima seperti ${i?.name} berasal dari penerima yang diimpor dan diisi saat pengiriman.`)
};

export const messages_norecipientshint2 = /** @type {(inputs: Messages_Norecipientshint2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Impor penerima terlebih dahulu - pelengkapan otomatis ${i?.slot} dan pratinjau menggunakannya.`)
};

export const messages_picklabel1 = /** @type {(inputs: Messages_Picklabel1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Template pesan`)
};

export const messages_pickplaceholder1 = /** @type {(inputs: Messages_Pickplaceholder1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Pilih template pesan untuk disalin…`)
};

export const messages_saveas1 = /** @type {(inputs: Messages_Saveas1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Simpan sebagai template`)
};

export const messages_saveastitle2 = /** @type {(inputs: Messages_Saveastitle2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Simpan pesan sebagai template`)
};

export const messages_saveasdescription2 = /** @type {(inputs: Messages_Saveasdescription2Inputs) => LocalizedString} */ () => {
...
export const messages_saveascreated2 = /** @type {(inputs: Messages_Saveascreated2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Disimpan sebagai template "${i?.name}".`)
};

export const messages_deletetitle1 = /** @type {(inputs: Messages_Deletetitle1Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Hapus template pesan "${i?.name}"?`)
};

export const messages_deletedescription1 = /** @type {(inputs: Messages_Deletedescription1Inputs) => LocalizedString} */ () => {
...
export const messages_subjectdetail1 = /** @type {(inputs: Messages_Subjectdetail1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Subjek`)
};

export const messages_bodydetail1 = /** @type {(inputs: Messages_Bodydetail1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Isi HTML`)
};

export const messages_nobodyyet2 = /** @type {(inputs: Messages_Nobodyyet2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Template ini memiliki isi kosong.`)
};

export const messages_copyonpickhint3 = /** @type {(inputs: Messages_Copyonpickhint3Inputs) => LocalizedString} */ () => {
...
export const messages_savetemplate1 = /** @type {(inputs: Messages_Savetemplate1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Simpan template`)
};

export const messages_name = /** @type {(inputs: Messages_NameInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Nama template`)
};

export const generate_title = /** @type {(inputs: Generate_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Generate`)
};

export const generate_description = /** @type {(inputs: Generate_DescriptionInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Buat dokumen untuk penerima terpilih - tanpa perlu konfigurasi email.`)
};

export const generate_pastjobs1 = /** @type {(inputs: Generate_Pastjobs1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Riwayat Generate`)
};

export const generate_pastjobsempty2 = /** @type {(inputs: Generate_Pastjobsempty2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Belum ada riwayat generate.`)
};

export const generate_jobtemplate1 = /** @type {(inputs: Generate_Jobtemplate1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Template`)
};

export const generate_jobstatus1 = /** @type {(inputs: Generate_Jobstatus1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Status`)
};

export const generate_jobcreated1 = /** @type {(inputs: Generate_Jobcreated1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Dibuat`)
};

export const generate_reopenjob1 = /** @type {(inputs: Generate_Reopenjob1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Buka`)
};

export const generate_reopenedtitle1 = /** @type {(inputs: Generate_Reopenedtitle1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Hasil Pekerjaan`)
};

export const generate_savepdf1 = /** @type {(inputs: Generate_Savepdf1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Simpan PDF`)
};

export const generate_couldnotsavepdf3 = /** @type {(inputs: Generate_Couldnotsavepdf3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tidak dapat menyimpan PDF.`)
};

export const generate_couldnotloadjobs3 = /** @type {(inputs: Generate_Couldnotloadjobs3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tidak dapat memuat riwayat generate.`)
};

export const generate_couldnotreopenjob3 = /** @type {(inputs: Generate_Couldnotreopenjob3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tidak dapat membuka kembali pekerjaan generate.`)
};

export const generate_jobnolongerexists3 = /** @type {(inputs: Generate_Jobnolongerexists3Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Pekerjaan generate ini sudah tidak ada.`)
};

export const generate_startdisabledcoverage2 = /** @type {(inputs: Generate_Startdisabledcoverage2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Pilih penerima yang datanya lengkap untuk semua slot agar bisa generate.`)
};

export const generate_retryjobhint2 = /** @type {(inputs: Generate_Retryjobhint2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Isi awal ruang kerja dengan penerima dan template pekerjaan ini`)
};

export const generate_prefilldeletedone2 = /** @type {(inputs: Generate_Prefilldeletedone2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.count} penerima pekerjaan telah dihapus dan tidak diisi ulang.`)
};

export const generate_prefilldeletedother2 = /** @type {(inputs: Generate_Prefilldeletedother2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.count} penerima pekerjaan telah dihapus dan tidak diisi ulang.`)
};

export const generate_routingtitle1 = /** @type {(inputs: Generate_Routingtitle1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Perutean template`)
};

export const generate_routinghint1 = /** @type {(inputs: Generate_Routinghint1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Pilih kolom yang nilainya menentukan template untuk setiap penerima.`)
};

export const generate_routingcolumnlabel2 = /** @type {(inputs: Generate_Routingcolumnlabel2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Rutekan berdasarkan kolom`)
};

export const generate_routingcolumnnone2 = /** @type {(inputs: Generate_Routingcolumnnone2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tidak ada - satu template untuk semua penerima`)
};

export const generate_routingcolumnsuggested2 = /** @type {(inputs: Generate_Routingcolumnsuggested2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.column} (disarankan)`)
};

export const generate_defaulttemplatelabel2 = /** @type {(inputs: Generate_Defaulttemplatelabel2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Template default (nilai kosong)`)
};

export const generate_defaulttemplatehint2 = /** @type {(inputs: Generate_Defaulttemplatehint2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Penerima dengan nilai ${i?.column} kosong memakai template ini.`)
};

export const generate_assignmenttitle1 = /** @type {(inputs: Generate_Assignmenttitle1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tetapkan setiap nilai ke template`)
};

export const generate_assignmenthint1 = /** @type {(inputs: Generate_Assignmenthint1Inputs) => LocalizedString} */ () => {
...
export const generate_assignedto1 = /** @type {(inputs: Generate_Assignedto1Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Template untuk "${i?.value}"`)
};

export const generate_valuecountone2 = /** @type {(inputs: Generate_Valuecountone2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.count} penerima`)
};

export const generate_valuecountother2 = /** @type {(inputs: Generate_Valuecountother2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.count} penerima`)
};

export const generate_unassignedsummary1 = /** @type {(inputs: Generate_Unassignedsummary1Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.count} penerima memiliki nilai kolom template yang belum ditetapkan ke template mana pun.`)
};

export const generate_unassignedvalueone2 = /** @type {(inputs: Generate_Unassignedvalueone2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`"${i?.value}" - ${i?.count} penerima: ${i?.names}`)
};

export const generate_unassignedvalueother2 = /** @type {(inputs: Generate_Unassignedvalueother2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`"${i?.value}" - ${i?.count} penerima: ${i?.names}`)
};

export const generate_allvaluesassigned2 = /** @type {(inputs: Generate_Allvaluesassigned2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Semua nilai kolom template sudah ditetapkan ke template.`)
};

export const generate_patternlabel1 = /** @type {(inputs: Generate_Patternlabel1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Pola penamaan berkas (dipakai bersama semua template)`)
};

export const generate_patternhint1 = /** @type {(inputs: Generate_Patternhint1Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Semua penerima pekerjaan ini dinamai dengan satu pola ini, apa pun template yang dipakai.`)
};

export const generate_jobpatternplaceholder2 = /** @type {(inputs: Generate_Jobpatternplaceholder2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`mis. BATCH_${i?.name}.pdf`)
};

export const generate_templatecoverageok2 = /** @type {(inputs: Generate_Templatecoverageok2Inputs) => LocalizedString} */ (i) => {
...
export const generate_templatecoveragemissing2 = /** @type {(inputs: Generate_Templatecoveragemissing2Inputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`${i?.missing} dari ${i?.count} penerima yang dirutekan ke template ini kekurangan data untuk:`)
};

export const generate_startdisabledrouting2 = /** @type {(inputs: Generate_Startdisabledrouting2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tetapkan setiap nilai kolom template ke sebuah template untuk membuat.`)
};

export const generate_startdisabledpattern2 = /** @type {(inputs: Generate_Startdisabledpattern2Inputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Perbaiki pola nama berkas - pola merujuk slot yang tidak dideklarasikan salah satu template.`)
};

export const generate_allblankvalues2 = /** @type {(inputs: Generate_Allblankvalues2Inputs) => LocalizedString} */ (i) => {
